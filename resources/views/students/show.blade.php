          ...
          @if ($studentCertificates->isEmpty())
            <div class="card-body">
              <h5>
                ...
                si considera que es un error por favor dar clic en el botón Centre de Asistencia - CUN,
                y coloca un requerimiento de tu caso.
              </h5>
            </div>
                ...
                <div class="row">
                  <table class="table align-middle table-striped table-hover table-sm mt-3">
                    ...
                    @foreach ($studentCertificates as $item)
                      <tr>
                        <td>{{ $item->Nombre_completo_participante }}</td>
                        <td>{{ $item->Email }}</td>
